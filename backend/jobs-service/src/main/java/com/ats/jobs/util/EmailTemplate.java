...
public final class EmailTemplate {
    ...
    public static String infoBox(String label, String content) {
        return "<div style=\"background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;padding:20px 24px;margin:24px 0 28px;\">" +
                ...
                "<div style=\"margin:0;font-size:14px;color:#374151;line-height:1.7;\">" + content + "</div>" +
                "</div>";
    }
    ...
    public static String detailBox(String label, String[][] rows) {
        ...
        table.append("</table>");
        return infoBox(label, table.toString());
    }
