          ...
          <form onSubmit={(e) => handleSubmit(e, false)} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 border rounded-lg text-gray-900 placeholder-gray-400 ${errors.title ? "border-red-300" : "border-gray-300"
                  }`}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className={`w-full px-4 py-2.5 border rounded-lg text-gray-900 placeholder-gray-400 resize-y ${errors.description ? "border-red-300" : "border-gray-300"
                  }`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 border rounded-lg text-gray-900 placeholder-gray-400 ${errors.location ? "border-red-300" : "border-gray-300"
                    }`}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 border rounded-lg text-gray-900 ${errors.employmentType ? "border-red-300" : "border-gray-300"
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full px-4 py-2.5 border rounded-lg text-gray-900 ${errors.experienceLevel ? "border-red-300" : "border-gray-300"
